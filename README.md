...
Если в нашем проекте, по какой-то причине все еще нет Lombok, то давайте добавим его прямо сейчас!
...
## Как добавить в контейнер уже существующий объект, которы был создан из вне?

Тут тоже нет ничего сложного и есть целый два решения!
...
Этот вопрос ты так-же рассмотрим на примере.
...
Если у вас есть желание изучить этот мир, то в интернете полно материала по одному из самых популярный java framework'ов
